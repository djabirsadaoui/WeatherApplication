...
class ShowWeatherDetailRouter: NSObject, ShowWeatherDetailRoutingLogic, ShowWeatherDetailDataPassing {
  ...
  //func navigateToSomewhere(source: ShowWeatherDetailViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: ShowWeatherDetailDataStore, destination: inout SomewhereDataStore)
  //{
